...
public class Form {
    ...
    public String getPopupText() {
        ...
        new WebDriverWait(driver, Duration.ofSeconds(15))
                .until(ExpectedConditions.visibilityOf(popupElement));
        return popupElement.getText();
    }

    public void setState(State stateAcronym) {
        driver.findElement(By.id("state")).sendKeys(stateAcronym.toString());
    }
}